...
public class MenuServiceImpl implements MenuService {
    ...
    public MenuUpdateGetResponseDto updateGetMenu(MenuUpdateGetRequestDto requestDto) {
        Menu menu = menuRepository.findById(requestDto.getMenuId())
            .orElseThrow(() -> new RuntimeException("Menu not found"));
        List<MenuOption> menuOptionList = menuOptionRepository.findAllByMenuIdAndStatus(
    ...
    public MenuDetailResponseDto getMenuDetail(MenuDetailRequestDto requestDto) {
        List<MenuOption> menuOptions = menuOptionRepository.findAllByMenuIdAndStatus(requestDto.getMenuId(), "일반");
