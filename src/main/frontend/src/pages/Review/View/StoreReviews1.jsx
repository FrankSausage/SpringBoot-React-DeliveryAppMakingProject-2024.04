...
export default function StoreReviews() {
  ...
  return (
    <Box>
      ...
      <Paper elevation={3} sx={{ height: 'auto', backgroundImage: 'url(/img/flat.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundBlendMode: 'lighten', backgroundColor: 'rgba(255, 255, 255, 0.6)', p: 2 }}>
        <Box sx={{ flexGrow: 5 }}>
          <Button variant="contained" onClick={() => navigate(-1)} sx={{mb: 2,backgroundColor: 'transparent',color: 'black', boxShadow: 'none', '&:hover': {backgroundColor: 'rgba(0, 0, 0, 0.1)',},}}>
            ◀ 뒤로가기
          </Button>
        </Box>
