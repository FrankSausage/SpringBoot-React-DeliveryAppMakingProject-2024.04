  ...
  return (
    <Box sx={{ backgroundColor: '#f8f8f8', m: -1 }}>
      ...
      <Box sx={{ borderBottom: 1, borderColor: 'divider', display: 'flex', alignItems: 'center', bgcolor: '#fff' }}>
        ...
        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example" variant="scrollable" scrollButtons="auto" sx={{ flexGrow: 8 }}>
      ...
      <Paper elevation={3} sx={{ minHeight: '100vh', backgroundImage: 'url(/img/cooking.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundBlendMode: 'lighten', backgroundColor: 'rgba(255, 255, 255, 0.6)', p: 2, overflowY: 'auto' }}>
