...
export default function Store() {
  ...
  return (
    <Box sx={{ backgroundColor: '#f8f8f8', m: -1}}>
      ...
      <Paper elevation={3} sx={{minHeight: '100vh', maxHeight: 'auto', backgroundImage: 'url(/img/001.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundBlendMode: 'lighten', backgroundColor: 'rgba(255, 255, 255, 0.55)', p: 2, overflowY: 'auto' }}>
