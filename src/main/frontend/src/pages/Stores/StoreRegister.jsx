...
export default function StoreRegister() {
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <SearchHeader />
<<<<<<< HEAD
      <div style={{ backgroundImage: 'url(/img/wooden.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', display: 'flex', justifyContent: 'center', padding: '23px 0', backgroundBlendMode: 'lighten', backgroundColor: 'rgba(255, 255, 255, 0.6)' }}>
=======
      <Paper sx={Paperstyle}>
>>>>>>> main
