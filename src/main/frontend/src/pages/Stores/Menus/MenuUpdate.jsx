  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      ...
      {!isLoading && menu.menus &&
        <Box>
          <SearchHeader />
          <div style={{ backgroundImage: 'url(/img/111.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', display: 'flex', justifyContent: 'center', padding: '23px 0', backgroundBlendMode: 'lighten', backgroundColor: 'rgba(255, 255, 255, 0.35)'}}>
