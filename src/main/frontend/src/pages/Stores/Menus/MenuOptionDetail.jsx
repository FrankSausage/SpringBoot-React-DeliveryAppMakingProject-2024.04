				...
				<Box sx={style}>
					{options.map((data) => (
						<Box key={data.menuOptionId} component={Form} sx={{ border: 1, borderRadius: 2, mb: 1 }}>
							<Stack sx={{ justifyContent: 'space-between', alignItems: 'center', px: 1 }}>
								<Grid Container>
									<Grid item sx={{ py: 2, textAlign: 'center' }}>
								...
								<Grid Container>
									<Grid item>
										<Stack direction={'row'} spacing={2} sx={{ alignContent: "center", my: 1 }}>
